...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = ['Tpye LOrd','BY LOrd','ONLY LOrd'];
    var i = -1;
    var j = 0;
...
Client.on("guildMemberAdd", member => { 
 /// ALPHA  , Codes /// Galal
  member.guild.channels.find("name","join-leave").send(member.toString() + " is de server gejoined")  /// ALPHA  , Codes /// Galal
  member.addRole(member.guild.roles.find("name","Mundo"));  /// ALPHA  , Codes /// Galal
  member.addRole(member.guild.roles.find("name","Member"));  /// ALPHA , Codes /// Galal
...
client.login("NTQ2MDY2NDQwNjg0MzA2NDQz.D09fuA.2_oF4Jaemsmvs1WvuDmtM7AFgUU");//توكن الخاص ببوت حقك
...
client.on('message', message => {
            if (message.content === 'السلام عليكم') {   // الكلام الذي تكتبه عشان يرد عليك بصوره
              message.channel.sendFile("وعليكم السلام");  // الصوره .. لازم نفس الي كاتبه انا
...
client.on('message', message => {
            if (message.content === 'باك') {   // الكلام الذي تكتبه عشان يرد عليك بصوره
              message.channel.sendFile("ولكم منور يقلبي اسمتع");  // الصوره .. لازم نفس الي كاتبه انا
...
client.on('message', message => {
            if (message.content === '@') {   // الكلام الذي تكتبه عشان يرد عليك بصوره
              message.channel.sendFile("wlecome to servr hav fan**");  // الصوره .. لازم نفس الي كاتبه انا
...
client.on('message', message => {
            if (message.content === '.') {   // الكلام الذي تكتبه عشان يرد عليك بصوره
              message.channel.sendFile("نقط ولا عسل ههي");  // الصوره .. لازم نفس الي كاتبه انا
